        ...
        <div class="auth-form">
          <div class="card mt-5">
            <div class="card-body">
              ...
              <div class="form-floating mb-3">
                <input type="year" class="form-control" id="floatingInput2" placeholder="Email Address / Username" name="vehicleYear"/>
...
if (isset($_POST['submit'])){
  $plate_number= $_POST['vehicleid'];
  $vehicle_type = $_POST['tripid'];
  $vehicle_model = $_POST['driverid'];
  $vehicl_eyear = $_POST['timedepture'];
  $status = "available";
