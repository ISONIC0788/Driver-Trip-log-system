...
if(isset($_GET['id'])){
    $user_id = $_GET['id'];
    $sqluser = "SELECT * FROM vehicle where  vehicle_id = '$user_id'";
        ...
        <div class="auth-form">
          <div class="card mt-5">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" placeholder="First Name" name="firtname" value="<?php ?>" />
                    <label for="floatingInput">First Name</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput1" placeholder="Last Name" value ="<?php  ?>" name="lastname"  />
              ...
              <div class="form-floating mb-3">
                <input type="phone" class="form-control" id="floatingInput2" placeholder="Phone Number" value="<?php ?>" name="phonenumber"/>
                <label for="floatingInput2">Phone Number</label>
              </div>
              <div class="form-floating mb-3">
                <input type="email" class="form-control" id="floatingInput2" placeholder="Email Address / Username" value="<?php ?>" name="email" />
                <label for="floatingInput2">Email Address </label>
              </div>
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput3" placeholder="Password" value ="<?php ?>" name="password" />
