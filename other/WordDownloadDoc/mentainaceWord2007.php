...
//   $ve = "SELECT * FROM vehicles";
  ...
  $mentaince="SELECT * FROM maintenance";
  // result for table user 

  $result2 = $conn->query($mentaince);
  ...
  $table->addRow();
  $table->addCell(2000)->addText('Mentaince ID', ['bold'=>true]);
  $table->addCell(4000)->addText('Vehicle ID',['bold'=>true]);
  $table->addCell(6000)->addText('Mentaince Type',['bold'=>true]);
  $table->addCell(8000)->addText('Start service Date',['bold'=>true]);
  $table->addCell(10000)->addText('End Service Date',['bold'=>true]);
