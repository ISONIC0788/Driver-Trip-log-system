...
//   $ve = "SELECT * FROM vehicles";
  ...
  $requesttrip="SELECT * FROM `request_for_trip`";
  // result for table user 

  $result2 = $conn->query($requesttrip);
  ...
  $table->addCell(6000)->addText('Request Date',['bold'=>true]);
  $table->addCell(8000)->addText('Status',['bold'=>true]);
